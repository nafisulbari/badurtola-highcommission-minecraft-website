document.addEventListener('DOMContentLoaded', () => {
            ...
            const seasonImages = {
                season1: [
                    { src: '/image/season1/02.png', alt: '' },
                    { src: '/image/season1/03.png', alt: '' },
                    { src: '/image/season1/04.png', alt: '' },
                    { src: '/image/season1/05.png', alt: '' },
                    { src: '/image/season1/06.png', alt: '' },
                    { src: '/image/season1/07.png', alt: '' },
                    { src: '/image/season1/08.png', alt: '' },
                    { src: '/image/season1/09.png', alt: '' },
                    { src: '/image/season1/10.png', alt: '' },
                    { src: '/image/season1/11.png', alt: '' },
                    { src: '/image/season1/12.png', alt: '' },
                    { src: '/image/season1/13.png', alt: '' },
                    { src: '/image/season1/14.png', alt: '' },
                    { src: '/image/season1/15.png', alt: '' },
                    { src: '/image/season1/16.png', alt: '' },
                    { src: '/image/season1/17.png', alt: '' },
                    { src: '/image/season1/18.jpg', alt: '' },
                    { src: '/image/season1/19.png', alt: '' },
                    { src: '/image/season1/20.png', alt: '' },
                    { src: '/image/season1/21.png', alt: '' },
                ],
                season2: [
                    { src: '/image/season2/01.png', alt: '' },
                    { src: '/image/season2/02.png', alt: '' },
                    { src: '/image/season2/03.png', alt: '' },
                    { src: '/image/season2/04.png', alt: '' },
                    { src: '/image/season2/05.png', alt: '' },
                    { src: '/image/season2/06.png', alt: '' },
                    { src: '/image/season2/07.png', alt: '' },
                    { src: '/image/season2/08.png', alt: '' },
                ]
            };
